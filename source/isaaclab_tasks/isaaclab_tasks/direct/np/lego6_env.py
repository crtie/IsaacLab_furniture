...
from .np_env_cfg import OBS_DIM_CFG, STATE_DIM_CFG, FrankaLego6Cfg
...
class FrankaLego6Env(DirectRLEnv):
    cfg: FrankaLego6Cfg

    def __init__(self, cfg: FrankaLego6Cfg, render_mode: str | None = None, **kwargs):
