...
from .np_env_cfg import OBS_DIM_CFG, STATE_DIM_CFG, FrankaLego5Cfg
...
class FrankaLego5Env(DirectRLEnv):
    cfg: FrankaLego5Cfg

    def __init__(self, cfg: FrankaLego5Cfg, render_mode: str | None = None, **kwargs):
