...
from .np_env_cfg import OBS_DIM_CFG, STATE_DIM_CFG, FrankaLego7Cfg
...
class FrankaLego7Env(DirectRLEnv):
    cfg: FrankaLego7Cfg

    def __init__(self, cfg: FrankaLego7Cfg, render_mode: str | None = None, **kwargs):
    ...
    def randomize_initial_state(self, env_ids):
        ...
        while True:
            ...
            above_fixed_pos_rand = 0.001 * (rand_sample - 0.5)   # [-1, 1] # [-0.5, 1.5]
