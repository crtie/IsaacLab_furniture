...
from .np_env_cfg import OBS_DIM_CFG, STATE_DIM_CFG, FrankaLego4Cfg
...
class FrankaLego4Env(DirectRLEnv):
    cfg: FrankaLego4Cfg

    def __init__(self, cfg: FrankaLego4Cfg, render_mode: str | None = None, **kwargs):
    ...
    def randomize_initial_state(self, env_ids):
        ...
        if self.cfg_task.task_idx == 1:
            rot_euler = torch.tensor([1.5707, 0, +1.5707], device=self.device).repeat(
            self.num_envs, 1
            )
